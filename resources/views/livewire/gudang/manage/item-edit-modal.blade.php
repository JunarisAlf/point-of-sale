           ...
           <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all dark:bg-zinc-600">
               <div class="bg-white dark:bg-zinc-700">
                   ...
                   <div class="p-6 space-y-6 ltr:text-left rtl:text-right">
                        ...
                        <div class="mb-3" x-data='opt' x-effect="updateVal({{$buying_price}})">
                            ...
                            <div class="relative rounded  @error('buying_price') border-red-500 border-[0.5px]  @enderror">
                                <input name="buying_price" type="text"  wire:ignore
                                    ...
                                    id="buying_price_mask" value="{{ $buying_price }}"  x-data x-init="imaskObj = new IMask($el, imaskOpt)" x-on:input="clearTimeout(inputTimeOut); inputTimeOut = setTimeout(() => {$wire.set('buying_price', imaskObj.unmaskedValue)}, 500)" >
                                    @error('buying_price')
