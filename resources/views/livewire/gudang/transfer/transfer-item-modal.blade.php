                   ...
                   <div class="p-6 space-y-6 ltr:text-left rtl:text-right">
                        <div class="relative overflow-x-auto overflow-y-auto">
                            ...
                            <div class="mb-4">
                                ...
                                <select id="countries" class="bg-white border border-gray-300  @error('cabang_id') border-red-500 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-zinc-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model="cabang_id">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    <input name="quantity" class="w-full rounded border-gray-100 @error('quantity') border-red-500 @enderror placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" wire:model="quantity" type="number" min="0" max="{{$stock_quantity}}">
                                    @error('quantity')
                                        <i class='bx bx-error-circle absolute text-xl text-red-500 ltr:right-2 rtl:left-2 top-2'></i>
                                    @enderror
                                </div>
                                <div class="text-xs text-red-500 mt-2">Min 0, Max: {{$stock_quantity}}</div>
                                @error('quantity')
                                    <div class="text-xs text-red-500 mt-2">{{$message}}</div>
                                @enderror
                            </div>
