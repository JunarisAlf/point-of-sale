    ...
    <div class="col-span-12">
       <div class="card dark:bg-zinc-800 dark:border-zinc-600">
            <div class="card-body pb-0">
                <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100 font-bold">Barang Belum Diperiksa</h6>
            </div>
           <div class="card-body">
                                   ...
                                   @endphp
                                    <tr >
                                        ...
                                        @if($stocks_count > 0)
                                            ...
                                            <td class="px-6 py-4 dark:text-zinc-100/80 text-center border-[1px]">
                                                <button wire:click="makeCorrection({{$item->stocks[0]->id}})" type="button" class="btn text-white bg-yellow-500 border-yellow-500 hover:bg-yellow-600 hover:border-yellow-600 focus:bg-yellow-600 focus:border-yellow-600 focus:ring focus:ring-yellow-500/30 active:bg-yellow-600 active:border-yellow-600"><i class="mdi mdi-square-edit-outline text-16 align-middle "></i></button>
                                                <button wire:click="markAsCorrect({{$item->stocks[0]->id}})" type="button" class="btn text-white bg-green-500 border-green-500 hover:bg-green-600 hover:border-green-600 focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-500/30 active:bg-green-600 active:border-green-600"><i class="bx bx-check-double text-16 align-middle "></i></button>
                                            </td>
                                        @endif
                                        ...
                                        @if($stocks_count > 1)
                                            @for($i = 1; $i < $stocks_count; $i++)
                                                    ...
                                                    <td class="px-6 py-4 dark:text-zinc-100/80 text-center border-[1px]">
                                                        <button wire:click="makeCorrection({{$item->stocks[$i]->id}})" type="button" class="btn text-white bg-yellow-500 border-yellow-500 hover:bg-yellow-600 hover:border-yellow-600 focus:bg-yellow-600 focus:border-yellow-600 focus:ring focus:ring-yellow-500/30 active:bg-yellow-600 active:border-yellow-600"><i class="mdi mdi-square-edit-outline text-16 align-middle "></i></button>
                                                        <button wire:click="markAsCorrect({{$item->stocks[$i]->id}})" type="button" class="btn text-white bg-green-500 border-green-500 hover:bg-green-600 hover:border-green-600 focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-500/30 active:bg-green-600 active:border-green-600"><i class="bx bx-check-double text-16 align-middle "></i></button>
                                                    </td>
                                                </tr>
                                            @endfor
                                        @endif
