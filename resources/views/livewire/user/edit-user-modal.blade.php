       ...
       <div class="animate-translate p-4 sm:max-w-4xl mx-auto">
           <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all dark:bg-zinc-600">
               <div class="bg-white dark:bg-zinc-700">
                   ...
                   <div class=" overflow-x-auto overflow-y-auto p-6 space-y-6 ltr:text-left rtl:text-right" style="height: 70vh">
                    <div class="relative ">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="example-text-input" class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Username</label>
                            <div class="relative">
                                <input name="username" class="w-full rounded border-gray-100 @error('username') border-red-500 @enderror placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" wire:model="username" type="text" autocomplete="new-password">
                                @error('username')
                                    <i class='bx bx-error-circle absolute text-xl text-red-500 ltr:right-2 rtl:left-2 top-2'></i>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input name="password" class="w-full rounded border-gray-100 @error('password') border-red-500 @enderror placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" wire:model="password" type="password" autocomplete="new-password" placeholder="Hanya di isi jika ingin merubah password">
                                @error('password')
                                    <i class='bx bx-error-circle absolute text-xl text-red-500 ltr:right-2 rtl:left-2 top-2'></i>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            <label for="example-text-input" class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Konfirmasi Password</label>
                            <div class="relative">
                                <input name="password_confirmation" class="w-full rounded border-gray-100 @error('password_confirmation') border-red-500 @enderror placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" wire:model="password_confirmation" type="password" placeholder="Hanya di isi jika ingin merubah password">
                        ...
                        <div class="mb-4">
                            <div class="mb-3">
                                ...
                                <img class="rounded-full w-48 h-48 mx-auto my-4" src="{{asset("storage/profile/$profile_image")}}">
