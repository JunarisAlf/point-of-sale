                ...
                <div class="bg-white dark:bg-zinc-600">
                     <div class="sm:flex sm:items-start p-5">
                        ...
                        <div class="mt-3 text-center sm:mt-0 ltr:sm:ml-4 rtl:sm:mr-4 ltr:sm:text-left rtl:sm:text-right">
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100" id="modal-title">Konfirmasi Pelunasan!</h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-zinc-100/80">Apakah kamu yakin akan merubah status barang menjadi Telah Tiba?</p>
                            </div>
                            <div class="mt-2">
                     ...
                     <div  class="bg-gray-50 px-4 py-3 sm:flex ltr:sm:flex-row-reverse sm:px-6 dark:bg-zinc-700">
                        <button  wire:click='markArrived({{$data_id}})' type="button" class="btn inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm dark:focus:ring-red-500/30">Konfirmasi</button>
