                           ...
                           @else
                               @foreach ($items as $key => $item)
                                    <tr >
                                        ...
                                        <td class="w-min">
                                            <div>
                                                <input name="quantity" class="rounded border-gray-100 @error('quantity') border-red-500 @enderror placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100" wire:model="item[{{$item['id']}}][quantity]" type="number" min="1">
                                                @error('quantity')
