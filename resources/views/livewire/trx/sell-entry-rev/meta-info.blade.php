        ...
        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
            <div class="card-header border-b border-gray-50 p-5 dark:border-zinc-600 flex flex-col">
                <div class="flex flex-row justify-between">
                    ...
                    <h5 class="uppercase text-red-600 text-[34px] dark:text-gray-100 font-bold text-lg">Rp. {{number_format($grand_price, 0, ',', '.')}}</h5>
                </div>
                <div class="flex flex-row justify-between">
                    <h6 class="uppercase text-gray-600 dark:text-gray-100 font-bold text-md">Sub Total</h5>
                    <h5 class="uppercase text-red-500 text-[24px] dark:text-gray-100 font-bold text-md">
                        Rp. {{number_format($sub_total, 0, ',', '.')}}
                    </h5>
                </div>
                <div class="flex flex-row justify-between">
                    <h6 class="uppercase text-gray-600 dark:text-gray-100 font-bold text-md">Diskon</h5>
                    <h5 class="uppercase text-red-500 text-[18px] dark:text-gray-100 font-bold text-md">
